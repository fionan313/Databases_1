...
VALUES
    ('http://dummyimage.com/220x100.png/5fa2dd/ffffff', 1),
	('http://dummyimage.com/236x100.png/5fa2dd/ffffff', 2),
	('http://dummyimage.com/196x100.png/5fa2dd/ffffff', 3),
	('http://dummyimage.com/138x100.png/dddddd/000000', 4),
	('http://dummyimage.com/193x100.png/5fa2dd/ffffff', 5),
	('http://dummyimage.com/216x100.png/cc0000/ffffff', 6),
	(NULL, 7),
	('http://dummyimage.com/140x100.png/cc0000/ffffff', 8),
	('http://dummyimage.com/179x100.png/ff4444/ffffff', 9),
	('http://dummyimage.com/142x100.png/ff4444/ffffff', 10),
	('http://dummyimage.com/198x100.png/ff4444/ffffff', 11),
	(NULL, 12),
	('http://dummyimage.com/190x100.png/dddddd/000000', 13),
	('http://dummyimage.com/169x100.png/ff4444/ffffff', 14),
	('http://dummyimage.com/224x100.png/cc0000/ffffff', 15),
	('http://dummyimage.com/198x100.png/dddddd/000000', 16),
	('http://dummyimage.com/203x100.png/5fa2dd/ffffff', 17),
	('http://dummyimage.com/228x100.png/cc0000/ffffff', 18),
	('http://dummyimage.com/113x100.png/dddddd/000000', 19),
	(NULL, 20),
	('http://dummyimage.com/166x100.png/5fa2dd/ffffff', 21),
	('http://dummyimage.com/243x100.png/dddddd/000000', 22),
	('http://dummyimage.com/148x100.png/dddddd/000000', 23),
	('http://dummyimage.com/161x100.png/dddddd/000000', 24),
	('http://dummyimage.com/185x100.png/5fa2dd/ffffff', 25);
...
select user_name from users join follow on user_id = followee_id;

select image_url, user_name from photos join users on photos.user_id = users.user_id where user_name = 'money.man';

select user_name, users.user_id from users join photos on photos.user_id = users.user_id where image_url is null;

select user_name, users.user_id  from likes join users on likes.user_id = users.user_id join photos on photos.photo_id = likes.photo_id where photos.user_id = likes.user_id;

select user_name from users join photos on users.user_id = photos.user_id left join likes on photos.photo_id = likes.photo_id where likes.user_id is null;

select users.user_name from users join photos on users.user_id = photos.user_id join likes on photos.photo_id = likes.photo_id;
