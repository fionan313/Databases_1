...
create table photos (photo_id serial primary key, image_url varchar(50), user_id varchar(30)); /* Create table named photos with the variable photo_id (varchar), image_url (char), user_id (date) */
